 ...
 * the exercise asks for an app that knows who the borrower is, not for a login -- and the
 * cookie is httpOnly only so that page code has to go through here rather than reading it
 * off `document`, not because it protects anything.
 */
